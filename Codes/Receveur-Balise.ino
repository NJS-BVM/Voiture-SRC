...
void rssi2led(int RSSI,long freq){
  ...
  i=0;
  digitalWrite(v0,tab[i]);
  i++;
  digitalWrite(v1,tab[i]);
  i++;
  digitalWrite(v2,tab[i]);
  i++;
  digitalWrite(v3,tab[i]);
  i++;
  digitalWrite(v4,tab[i]);
  i++;
  digitalWrite(v5,tab[i]);
  i++;
  digitalWrite(v6,tab[i]);
